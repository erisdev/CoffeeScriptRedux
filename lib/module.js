...
var CoffeeScript, Compiler, cscodegen, escodegen, escodegenFormat, ext, formatParserError, MacroExpander, Nodes, Optimiser, Parser, pkg, Preprocessor;
...
MacroExpander = require('./macro-expander').MacroExpander;
cscodegen = function () {
  try {
...
CoffeeScript = {
  ...
  compile: function (csAst, options) {
    return Compiler.compile(MacroExpander.expand(csAst, options), options).toBasicObject();
  },
